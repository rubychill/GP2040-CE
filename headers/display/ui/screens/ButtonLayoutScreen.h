...
class ButtonLayoutScreen : public GPScreen {
    ...
    private:
        ...
        GPSpriteButton* addSpriteButton(uint16_t startX, uint16_t startY, uint16_t sizeX, uint16_t sizeY, uint16_t inputMask, bool dirInput, const unsigned char *releasedSpriteData, const unsigned char *pressedSpriteData);
